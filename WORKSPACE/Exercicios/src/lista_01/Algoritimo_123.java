...
public class Algoritimo_123 {
	...
	public static void main(String[] args) {
		...
		for(int lado:lados) {
			...
			if ( verifica_01 > num_03 && verifica_02 > num_02 && verifica_03 > num_03) {
				...
				Isoceles(lados[0],lados[1],lados[2]);
	...
	public static  int Escaleno(int a, int b, int c) {       		
	...
	public static int Isoceles(int a, int b, int c) {
		if (a == b &&  b == a && !(c == b) && !(c == a)   ){
	...
	public static int Equilatero(int a, int b, int c) {       		
